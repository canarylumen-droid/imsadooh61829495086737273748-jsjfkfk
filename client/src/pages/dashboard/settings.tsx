                ...
                <div className="relative group mb-6">
                  <div className="relative">
                    ...
                    <Avatar className="h-28 w-28 sm:h-32 sm:w-32 border-2 border-border/50 shadow-md ring-2 ring-primary/10 group-hover:ring-primary/30 transition-all duration-300 relative rounded-full">
                      {user.avatar?.endsWith('.pdf') ? (
                        <div className="flex flex-col items-center justify-center w-full h-full bg-gradient-to-br from-red-500/10 to-red-500/5 rounded-full p-4">
                          <svg viewBox="0 0 24 24" className="h-8 w-8 text-red-500 mb-1" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
                  ...
                  <input ref={fileInputRef} type="file" className="hidden" accept="image/*,.pdf" onChange={(e) => e.target.files?.[0] && uploadAvatarMutation.mutate(e.target.files[0])} />
                </div>
