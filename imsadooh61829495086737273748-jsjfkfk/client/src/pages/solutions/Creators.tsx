        ...
        <motion.div initial="initial" whileInView="animate" viewport={{ once: true }} variants={staggerContainer}>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            <motion.div variants={fadeInUp} className="space-y-6">
              ...
              <p className="text-[#b0aca3] text-sm md:text-base leading-relaxed">You&apos;re manually writing emails and tracking responses. 5-10 hours per week wasted. Low open rates. Forgetting follow-ups.</p>
              <ul className="space-y-3">
                {['Manual writing', 'Slow sequences', 'No personalization'].map((item, i) => (
                  <li key={i} className="flex items-center gap-3"><span className="text-[#2196f3]">✗</span><span className="text-[#b0aca3] text-sm md:text-base">{item}</span></li>
                ))}
              </ul>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="space-y-6">
              ...
              <p className="text-[#b0aca3] text-sm md:text-base leading-relaxed">Personalized emails at scale. Smart follow-ups. AI learns what works and optimizes every campaign automatically.</p>
              <ul className="space-y-3">
                {['Fully automated', 'Personalized at scale', '3x better response rates'].map((item, i) => (
                  <li key={i} className="flex items-center gap-3"><Check className="w-4 h-4 text-[#2196f3]" /><span className="text-[#b0aca3] text-sm md:text-base">{item}</span></li>
                ))}
              </ul>
            </motion.div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {['Gmail & Google Workspace', 'Outlook & Microsoft 365'].map((platform, i) => (
              <motion.div key={i} variants={fadeInUp} className="p-6 md:p-8 border border-[#1e1e1e] hover:border-[#2196f3]/40 transition-colors text-center">
                ...
                <p className="text-[#b0aca3] text-sm md:text-base">Sends cold emails securely</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
