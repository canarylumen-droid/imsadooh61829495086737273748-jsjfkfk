        ...
        <div className="grid lg:grid-cols-2 border-b border-[#1e1e1e]">
          ...
          <div className="border-r border-[#1e1e1e]">
            <div className="border-b border-[#1e1e1e] p-6">
              <p className="text-sm text-[#d0ccc3] leading-relaxed max-w-md">
                ...
                >
                  <div className="flex items-start gap-4">
                    <Icon className={`w-5 h-5 flex-shrink-0 mt-1 transition-colors ${
                      isActive ? "text-[#2196f3]" : "text-[#9a9a9a]"
                    }`} />
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-[#d0ccc3] leading-relaxed">{step.desc}</p>
                    </div>
                  </div>
                </button>
              );
            ...
            <div className="p-6 flex flex-col gap-3">
              ...
              <a href="#" className="font-mono text-[11px] text-[#d0ccc3] tracking-wider hover:text-[#f2ede6] transition-colors">
                BOOK A DEMO →
              </a>
            </div>
          </div>
