      ...
      >
        ...
        <div className="px-6 lg:px-12 h-14 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            {navLinks.map((link) => (
              <a
                key={link.name}
                href={link.href}
                className="font-mono text-[11px] tracking-[0.18em] text-[#d0ccc3] hover:text-[#2196f3] transition-colors duration-200"
              >
                {link.name}
              </a>
            ))}
          ...
          <div className="hidden md:flex items-center gap-4">
            <a
              href="/login"
              className="font-mono text-[11px] tracking-widest text-[#d0ccc3] hover:text-[#2196f3] transition-colors"
            >
              LOGIN
            </a>
            <a
      ...
      >
        ...
        <div className="mt-auto p-8 border-t border-[#1e1e1e] space-y-4">
          <a
            href="/login"
            onClick={() => setOpen(false)}
            className="w-full block text-center font-mono text-sm tracking-widest bg-[#0a0a0a] border border-[#1e1e1e] text-[#d0ccc3] py-5 hover:border-[#2196f3] hover:text-[#2196f3] transition-colors"
          >
            LOGIN
          </a>
          <a
