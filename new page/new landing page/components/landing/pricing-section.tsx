  ...
  return (
    <section id="pricing" ref={ref} className="relative border-t border-[#1e1e1e] bg-[#080808] scroll-mt-[88px]">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
            ...
            >
              ...
              <div className="p-8 border-b border-[#1e1e1e]">
                <div className="flex items-start justify-between mb-4">
                  <span className="font-mono text-[9px] text-[#9a9a9a]">{p.id}</span>
                  {p.highlight && (
                    <span className="font-mono text-[9px] tracking-widest border border-[#2196f3]/40 text-[#2196f3] px-2 py-1">
                      POPULAR
                    </span>
                ...
                <p className="font-mono text-[10px] text-[#b0b0b0] tracking-wider">{p.tagline}</p>
              </div>
              ...
              <div className="p-8 border-b border-[#1e1e1e]">
                {p.price.mo !== null ? (
                  <div className="flex items-baseline gap-2">
                    ...
                    <span className="font-mono text-[10px] text-[#b0b0b0]">/MONTH</span>
                  </div>
                ) : (
              ...
              <ul className="p-8 space-y-3 border-b border-[#1e1e1e]">
                {p.features.map(f => (
                  <li key={f} className="flex items-start gap-3">
                    ...
                    <span className="font-mono text-[11px] text-[#b0b0b0]">{f}</span>
                  </li>
                ))}
              </ul>
          ...
          {PLANS.slice(3).map((p, i) => (
            ...
            >
              ...
              <div className="p-8">
                <a
                  href="/signup"
                  className="w-full flex items-center justify-between font-mono text-[11px] tracking-widest px-5 py-4 transition-colors border border-[#2e2e2e] text-[#9a9a9a] hover:border-[#2196f3]/40 hover:text-[#2196f3]"
                >
                  {p.cta}
        ...
        <p className="py-5 text-center font-mono text-[10px] text-[#8abccc]">
