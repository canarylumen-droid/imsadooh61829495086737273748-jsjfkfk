      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20 overflow-hidden">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="mb-8">
            <p className="text-base text-[#9a9a9a] leading-relaxed max-w-2xl mx-auto">
              <TypingText 
          ...
          <ScrollStackItem itemClassName="bg-[#0e0e0e] border border-[#1e1e1e] hover:border-[#2196f3]/40 transition-colors">
            <div className="flex items-center gap-6 h-full px-8">
              ...
              <div>
                ...
                <p className="text-[#9a9a9a]">Plug into Salesforce, HubSpot, Pipedrive. Your workflows stay intact.</p>
              </div>
            </div>
          </ScrollStackItem>
          ...
          <ScrollStackItem itemClassName="bg-[#0e0e0e] border border-[#1e1e1e] hover:border-[#2196f3]/40 transition-colors">
            <div className="flex items-center gap-6 h-full px-8">
              ...
              <div>
                ...
                <p className="text-[#9a9a9a]">AI learns your exact closing style in 48 hours. Battle cards and scripts included.</p>
              </div>
            </div>
          </ScrollStackItem>
          ...
          <ScrollStackItem itemClassName="bg-[#0e0e0e] border border-[#1e1e1e] hover:border-[#2196f3]/40 transition-colors">
            <div className="flex items-center gap-6 h-full px-8">
              ...
              <div>
                ...
                <p className="text-[#9a9a9a]">Agents run under your brand. Clients never know it's AI.</p>
              </div>
            </div>
          </ScrollStackItem>
          ...
          <ScrollStackItem itemClassName="bg-[#0e0e0e] border border-[#1e1e1e] hover:border-[#2196f3]/40 transition-colors">
            <div className="flex items-center gap-6 h-full px-8">
              ...
              <div>
                ...
                <p className="text-[#9a9a9a]">70% margins per client. Scale to 100+ without new hires.</p>
              </div>
            </div>
          </ScrollStackItem>
          ...
          <ScrollStackItem itemClassName="bg-[#0e0e0e] border border-[#1e1e1e] hover:border-[#2196f3]/40 transition-colors">
            <div className="flex items-center gap-6 h-full px-8">
              ...
              <div>
                ...
                <p className="text-[#9a9a9a]">Revenue scales infinitely. Linear costs. Your margins compound.</p>
              </div>
            </div>
          </ScrollStackItem>
        </ScrollStack>
              ...
              <ScrollReveal key={idx}>
                <GlareHover className="text-center p-6 border border-[#1e1e1e] hover:border-[#2196f3]/40 transition-colors rounded-lg">
                  <BlurText>
                    ...
                    <div className="font-mono text-[10px] tracking-widest text-[#7a7a7a]">{metric.sub}</div>
                  </BlurText>
                </GlareHover>
              </ScrollReveal>
            ))}
              ...
              <tbody>
                {[
                  ...
                  <tr key={idx} className="border-b border-[#1e1e1e]">
                    <td className="py-4 pr-8 font-mono text-[#9a9a9a]">{row.feature}</td>
                    <td className="py-4 pr-8 text-[#2196f3]">{row.audnix}</td>
                    <td className="py-4 text-[#9a9a9a]">{row.hiring}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <motion.div initial="initial" whileInView="animate" viewport={{ once: true }} variants={staggerContainer} className="space-y-16">
          ...
          <motion.div variants={slideUp} className="grid md:grid-cols-2 gap-12">
            ...
            <motion.div variants={zoomIn} className="p-8 border border-[#2196f3]/20 bg-[#2196f3]/5 rounded-lg">
              ...
              <p className="font-mono text-[11px] tracking-widest text-[#7a7a7a]">— Sarah Chen, Founder, SalesScale Agency</p>
            </motion.div>
          </motion.div>
          ...
          <motion.div variants={rotateIn} className="bg-gradient-to-r from-[#2196f3]/10 to-transparent p-8 border border-[#2196f3]/20 rounded-lg">
            ...
            <p className="text-[#9a9a9a] mb-4 leading-relaxed">
            ...
            <p className="font-mono text-[10px] text-[#7a7a7a]">Launch your first Audnix instance today and lock in premium partner rates</p>
          </motion.div>
        </motion.div>
      </section>
            ...
            {[
              ...
              <motion.div key={i} variants={blurIn} className="border border-[#1e1e1e] rounded-lg overflow-hidden hover:border-[#2196f3]/40 transition-colors">
                <details className="group cursor-pointer">
                  ...
                  <motion.div variants={slideUp} className="px-6 pb-6 border-t border-[#1e1e1e] text-[#9a9a9a]">
                    {faq.a}
                  </motion.div>
                </details>
              </motion.div>
